...
"""
Django settings for PracticeWeb project.
...
SECRET_KEY = 'django-insecure-25q%a!cn%+7bk$z4vv=d7=6-9ii*a2o-%+j(l3-coth2v$u0nz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'PracticeWeb/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'PracticeWeb.wsgi.application'
